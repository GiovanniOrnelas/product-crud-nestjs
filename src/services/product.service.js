...
var ProductService = function () {
    ...
    var ProductService = _classThis = /** @class */ (function () {
        function ProductService_1(productRepository) {
            this.productRepository = productRepository;
        }
        ProductService_1.prototype.createAsync = function (productDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.productRepository.create(productDto)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
